...
### Features
  ...
  - Quickstart [AWS CloudFormation templates](../examples/lexical-graph/cloudformation-templates/) for Neptuen Database, OpenSearch Serverless, and Amazon Aurora Postgres.
