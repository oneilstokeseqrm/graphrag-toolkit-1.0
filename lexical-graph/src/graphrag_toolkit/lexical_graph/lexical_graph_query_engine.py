...
from graphrag_toolkit.lexical_graph.retrieval.retrievers import CompositeTraversalBasedRetriever, \
    SemanticGuidedRetriever
from graphrag_toolkit.lexical_graph.retrieval.retrievers import StatementCosineSimilaritySearch, KeywordRankingSearch, \
    SemanticBeamGraphSearch
from graphrag_toolkit.lexical_graph.retrieval.retrievers import WeightedTraversalBasedRetrieverType, \
...
class LexicalGraphQueryEngine(BaseQueryEngine):
    ...
    def __init__(self,
        ...
        if retriever:
            ...
            self.retriever = CompositeTraversalBasedRetriever(graph_store, vector_store, filter_config=filter_config,
                                                              **kwargs)
